...
export const fetchWeeklyStats = async (uid: string): Promise<ResponseType> => {
  try {
    ...
    console.log("ошибка при получении недельной статистики: ", err);
    return { success: false, msg: err.message };
  }
};
...
export const fetchMonthlyStats = async (uid: string): Promise<ResponseType> => {
  try {
    ...
    querySnapshot.forEach((doc) => {
      ...
      const rawMonthName = transactionDate.toLocaleString("ru-RU", {
        month: "short",
      });
    ...
    console.error("ошибка при получении ежемесячных транзакций: ", error);
    return {
      success: false,
      msg: "Не удалось получить данные о ежемесячных транзакциях",
    };
  }
};
...
export const fetchYearlyStats = async (uid: string): Promise<ResponseType> => {
  try {
    ...
    console.error("ошибка при получении данных о годовых транзакциях:", error);
    return {
      success: false,
      msg: "Не удалось получить данные о годовых транзакциях",
    };
  }
};
