    ...
    return (
        <ModalWrapper>
            ...
            <View style={styles.container}>
                ...
                <Header title="Редактировать профиль" leftIcon={<BackButton />} style={{ marginBottom: spacingY._10 }} />

                {/* Форма редактирования профиля */}
                <ScrollView contentContainerStyle={styles.form}>
                    {/* Контейнер для аватара с возможностью редактирования */}
                    <View style={styles.avatarContainer}>
                        <Image source={getProfileImage(userData.image)} style={styles.avatar} contentFit="cover" transition={100} />

                        {/* Кнопка редактирования аватара */}
                        <TouchableOpacity onPress={onPickImage} style={styles.editIcon}>

                            <MaterialCommunityIcons name="pencil" size={verticalScale(20)} color={colors.neutral800} />
                    ...
                    <View style={styles.inputContainer}>
                        <Typo color={colors.neutral200}>Имя</Typo>
                        <Input placeholder='Имя' value={userData.name} onChangeText={(value) => setUserData({ ...userData, name: value })} />
                    </View>
                </ScrollView>
            </View>
            ...
            <View style={styles.footer}>
                <Button onPress={onSubmit} loading={loading} style={{ flex: 1 }}>
                    <Typo fontWeight={"medium"} size={18}>Обновить</Typo>
                </Button>
